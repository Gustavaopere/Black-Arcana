...
| Leyline Spellbooks | installed `1.0.3`; JAR `leylines-1.0.3.jar`; CurseForge File ID `8565076`; physical modlist hash `5307a4edc885ab949eed4438d9d7f9cb6176421d` | `REFERENCE_ONLY / COMPATIBILITY_TARGET` publisher-public audit of Leyline school identity, nine signature-spell names as a lower bound, pillar/rift progression and 1.0.3 encounter rules | project is **All Rights Reserved**. No exact publisher source revision was located and inspectable binary bytes were not obtained in the permitted environment. Older external-index SHA-1 `dfa6908731f432905caaaa1e53b4aedeaa26ed59` is not treated as installed-artifact authority because it conflicts with the physical modlist. No source/JAR bytecode or assets were copied, decompiled or adapted; registry/API internals remain `REVIEW_REQUIRED` and fail-closed |
