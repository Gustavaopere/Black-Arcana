...
| Malum | installed `1.8.2`; exact version-line commit `SammySemicolon/Malum-Mod@03b743a37f3eeb0cc7f4364f0730e1f135f78408` | optional spirit/soul `DEPENDENCY_API / COMPATIBILITY_TARGET`; publisher changelog audit for catalog/dedup | **license conflict remains unresolved:** CurseForge declares GNU LGPLv3, while exact `gradle.properties` declares `All Rights Reserved` and no root LICENSE resolves the discrepancy. Only metadata/changelog-visible behavior is promoted; source-internal specification/reuse remains `REVIEW_REQUIRED`/blocked |
