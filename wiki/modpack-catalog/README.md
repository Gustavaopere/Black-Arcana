...
- Hazen N Stuff `1.4.0.14` — current physical JAR/SHA-1 certified by the sibling 22/09 re-audit; exact release-correlated source pin `5fcaf39c...` closes 39 active Iron's spell registrations, two localization-only roots excluded, custom focus/special craft gates reconciled, runtime QA still fail-closed;
