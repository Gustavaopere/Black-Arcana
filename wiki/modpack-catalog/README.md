...
- [`meta/PROVIDER-AUDIT-QUEUE-DELTA-DUNGEONS-DELIGHT.md`](meta/PROVIDER-AUDIT-QUEUE-DELTA-DUNGEONS-DELIGHT.md) — prevails for `dungeonsdelight` 1.5.1, closing its source-pinned food/effect/enchantment magic surface with zero provider-owned spell/ritual/action registry while assembled-pack runtime QA remains fail-closed.
...
- [`meta/CAPABILITY-MATRIX-DELTA-DUNGEONS-DELIGHT.md`](meta/CAPABILITY-MATRIX-DELTA-DUNGEONS-DELIGHT.md) records Dungeon's Delight effect/enchantment/food/XP/automation overlap while keeping those mechanics outside spell ownership.
...
- Dungeon's Delight `1.5.1` — current sibling row #416 plus exact official source pin `0c2d621...`; 12 mob effects and 2 enchantments are cataloged as status/gear support, with no spell/ritual/ability registry established; semantic delta is +0 and runtime/config/migration QA remains fail-closed;
