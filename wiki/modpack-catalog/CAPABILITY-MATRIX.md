...
| Soul / spirit / death economy | **Goety 3.1.4 Soul Energy is a provider-owned public-documented resource for Focus casting/artifices/servant-related systems; exact 3.1.4 API/settlement internals remain unverified**; Malum; **Eidolon 0.5.0.2 own Soul capability + Soul Shards + Crystal/Absorption/summoning surfaces source-pinned; entity-master semantics and serialized Absorption capture remain provider-owned**; Ars Hex Soul Shatter; Ars Elemental Phantom Grasp; **Bloodlines 3.0.9 Gravebound Souls + Devour + Phylactery storage + Mist Form/Possession costs source-pinned and explicitly separate from generic soul resources**; Black Arcana 07.02; Soul Fire'd related content | **SUBSTANTIAL PARTIAL COVERAGE PROVEN / CROSS-PROVIDER SOUL SEMANTICS MUST REMAIN DISTINCT** | BLOCKED |
...
| Fire / infernal / soul fire | Iron's Fire; Ars Nouveau Ignite/Flare; Ars Elemental fire interactions; Ars Zero Fire Voxel; **Goety public base inventory includes Ignite, Fire Breath and a 10-Focus Nether family (Fireball/Lava Bomb/Bombardment/Meteor Shower/Magma Bomb/Fire Blast/Flame Strike/Wither Skull/Ghastly/Blazing); exact 3.1.4 mechanics remain unverified**; **Eidolon Fire Chant source-pinned**; Somake 1.0.8 Soul/Infernal Fire ritual path; Ignis Soulfires addons; Soul Fire'd; Cataclysm integrations; **Vampiric Ageing 1.4.21 age-based fire/sun weakness divisors for Vampires source-pinned** | SUBSTANTIAL PARTIAL COVERAGE PROVEN / AUDIT INCOMPLETE | BLOCKED |
...
| Shields / wards / barriers | Iron's Shield/Fang Ward; Ars Elemental Bubble Shield; Paladin Bulwark/Bedrock Skin; Asterism Celestial Tether/Silvery Barbs; Ypsilon Saeptum provider-native spherical barrier/domain; **Goety public Magic inventory includes Iron Hide and Bulwark Focus names; exact 3.1.4 mechanics remain unverified**; **Vampirism Half Invulnerable (late blood settlement)**; **Werewolves form-specific damage reduction + Thick Fur are provider defensive mechanics, not generic ward spells**; Black Arcana fields | SUBSTANTIAL PARTIAL COVERAGE PROVEN / AUDIT INCOMPLETE | BLOCKED |
...
| Order / seals / imposed laws | Iron's control/countermagic; Ars Nouveau Rune/Wall/Snare/Dispel/Gravity; Ars Controle boolean filters/Precise Delay; Not Enough Glyphs Plane; Ars Zero Geometrize + geometry augments; Asterism Tether/Echo; Paladin defensive contracts; **Goety public 3.1.4-target inventory includes an `Order Focus`, but its exact semantics are not sufficiently verified to claim an imposed-law mechanic** | **LOGIC/GEOMETRY/CONSTRAINT PARTIAL COVERAGE PROVEN; GOETY ORDER NAME PROVEN BUT BEHAVIOR UNVERIFIED; AUTHORITATIVE LAW DELTA NOT YET PROVEN** | BLOCKED |
...
Boolean logic, runes, walls, immobilization, geometric spell placement, counters, shields, Not Enough Glyphs Plane and Ars Zero Geometrize/shape composition are already represented somewhere in the pack. Goety's current public inventory additionally proves the existence of an **Order Focus** name, but not enough exact 3.1.4 behavior to classify it as the proposed authoritative imposed-law mechanic. Order must therefore still prove an **authoritative imposed-law/seal system**, not a visual geometry rename or a name collision.
...
### Goety 3.1.4 release-pinned public boundary

Goety is exact-release-pinned to the installed `3.1.4` artifact, but the official public source path available during this audit does not expose an auditable exact `1.21.1/3.1.4` source pin. The catalog therefore separates public gameplay documentation from implementation internals.

Current public evidence establishes:

- **110 base Focus names across 10 provider categories**; the earlier 109 count was missing `Order Focus`;
- **12 Wands/Staffs** in the public casting inventory;
- **13 ritual families** and a Dark Altar-centered provider ritual model;
- **10 Research lines** controlling provider progression/unlocks;
- provider-owned **Soul Energy** for casting/artifices/servant-related systems;
- provider-owned servants/summons plus public **Summon Down** pressure semantics;
- provider-owned endgame **Lichdom**;
- witchcraft/preparation surfaces including Taglock and multiple Brew forms.

Important consequences:

- public names prove semantic coverage for deduplication, not exact JAR registry IDs or mechanics;
- Black Arcana must not invent a Goety Soul Energy mirror or charge/refund provider costs from guessed death/cast events;
- Goety servant owner/persistence/cap/lifespan must remain provider-native and cannot be overwritten by Black Arcana Binding/Familiar systems;
- one Focus activation must not be double-processed from item use, damage, spawn, Staff behavior or client Focus UI;
- ritual completion cannot be inferred from particles, altar proximity, sacrifice death or ingredient disappearance;
- RPG/Black Arcana progression must not unlock Goety Research/Focus content without a verified read/write boundary;
- Lichdom is a provider transformation, not a generic Black Arcana buff/state;
- Goety Taglock must be audited before Black Arcana creates a cosmetically different sympathetic-identity token;
- Goety Iron and Goety Cataclysm remain separate addon providers and are excluded from the base 110 count;
- any direct exact-3.1.4 integration that depends on unverified internals remains `FAIL-CLOSED / PENDING PROVIDER BOUNDARY`.
