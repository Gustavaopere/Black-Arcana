...
`CATALOG CLOSURE CANDIDATE / EXACT PHYSICAL+OFFICIAL SOURCE VERSION / RECIPE+CONTENT EXTENSION / NOT CANONICAL UNTIL LATEST-MAIN RECONCILIATION + EXACT-HEAD CI GREEN + MERGE`
...
- declared required Create range `[6.0.4,6.1.0)`;
- declared required Create: Enchantment Industry range `[2.0.0,)`;
