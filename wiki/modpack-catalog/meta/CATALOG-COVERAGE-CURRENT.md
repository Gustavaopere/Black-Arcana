...
## Current provider override — Dungeon's Delight 1.5.1

The current sibling certified dossier at `neoforge-rpg-skilltree@c3de5878d69a7a6b4441606ef2b9e96a61a8f2e9` records physical row #416 as `neoforge-dungeonsdelight-1.21.1-1.5.1.jar` / mod id `dungeonsdelight` / distribution 1.5.1, while preserving the installed internal-metadata divergence at 1.5.0. Exact official source pin `Yirmiri/Dungeons-Delight@0c2d621ebc7dcce3df5dad0ea485209ef2396f9c` declares 1.5.1.

The exact provider entrypoint registers item/block/entity/effect/recipe/etc. registries; `DDEffects` contributes 12 status effects and `DDEnchantments` contributes two gear enchantments. Exact-source search establishes no spell, ritual or ability registry. Dungeon's Delight is therefore **✅ cataloged** with **+0 independent semantic magic objects**, leaving the strict minimum at **1382**. The technical denominator remains `PENDING REBASE`; no new N/100 fraction is assigned.

See [Dungeon's Delight](../providers/%E2%9C%85-dungeons-delight/README.md) and [its exact source magic-surface inventory](../providers/%E2%9C%85-dungeons-delight/SOURCE-1.5.1-MAGIC-SURFACE.md).
