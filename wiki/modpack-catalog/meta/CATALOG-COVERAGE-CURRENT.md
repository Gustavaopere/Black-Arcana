...
**Current Somake override — 1.0.9.** The latest sibling modlist authority checked at `neoforge-rpg-skilltree@7e3a694fa76a8ea39c6d42e2d46ee385a98c6149` retains the physical Somake entry `somakespells-1.0.9-1.21.1.jar` / runtime `1.0.9`. Exact CurseForge file `8867079` was resource-audited clean-room at release SHA-1 `171841ac9f802be9309ecc166c1d972ac6d404c0`; 83 base spell-localization roots each have a matching `.guide` key, but localization is **not** registry proof. Black Arcana does not yet possess a physical-pack SHA-1 for byte-equality, and the exact 1.0.9 registry/optional gates/reachability remain open. Therefore Somake stays **⚠️ conditional / +0**, and all 1.0.8-fix exact-registry text below is historical only.
