...
| Static staff progression/loot | five staffs directly named/promoted by exact 2.0.2 + two additional names from earlier official 2.0.x lineage | provider item/encounter/loot authority | not BA progression unless an explicit deduplicated progression hook is designed |
