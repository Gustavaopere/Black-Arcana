...
| [Alshanex's Familiars](../providers/alshanex-familiars/README.md) 4.0.3 | 4.0 moves Sound ownership to Tunes; current 4.x release evidence proves **Switcheroo** and **Fire Fist** plus a data-driven ritual subsystem | `LOWER_BOUND / OPEN CURRENT INVENTORY` | at least 2 Alshanex-owned spells are proven, but the complete 4.0.3 spell and ritual inventories are not closed |
