...
| Mobstein `5.4.4` | Physical artifact identity closed; publisher-facing gameplay surfaces materialized object-by-object without ARR reverse engineering | Exact registry/resource identity and semantic action boundary: determine whether resurrection/surgery/syringe/perk workflows contain independent Mobstein-owned actions under the global metric, then resolve current-pack activation | [`⚠️-mobstein/REGISTRY-CLOSURE-CHECKLIST.md`](../providers/⚠️-mobstein/REGISTRY-CLOSURE-CHECKLIST.md) |
...
| Somake Spells `1.0.8-fix` | Exact hash-matched artifact; 67/67 current registry identities closed; optional registration gates already satisfied by physical provider set | Effective deployed `enableSpellLockSystem` interpretation plus object-level normal survival acquisition/unlock reachability for all 67 identities | [`⚠️-somake-spells/SURVIVAL-REACHABILITY-CHECKLIST.md`](../providers/⚠️-somake-spells/SURVIVAL-REACHABILITY-CHECKLIST.md) |
...
- Mobstein: publisher-facing object-level card tranches already merged;
- Not Enough Glyphs: source registration inventory and fallback namespace resolution;
- Somake: 67/67 exact registry identities and optional registration gates;
