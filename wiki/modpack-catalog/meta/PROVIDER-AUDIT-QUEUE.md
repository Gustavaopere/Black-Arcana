...
- esta revisão Phase 2AM fecha `apothic_attributes` como componente #41 ao limite exato de source-version disponível;
...
## Phase 2AM — Apothic Attributes 2.10.1

| Mod ID | Artefato físico | Estado da auditoria |
|---|---|---|
| `apothic_attributes` | `ApothicAttributes-1.21.1-2.10.1.jar` | EXACT PHYSICAL VERSION + EXACT OFFICIAL SOURCE VERSION PIN / COMBAT+ATTRIBUTE+EFFECT SUPPORT PROVIDER / 0 STANDALONE SPELLS+GLYPHS+RITUALS OBSERVED / 22 ATTRIBUTES / 7 EFFECTS / 31 POTIONS / 37 BREWING MIXES / 5 DAMAGE TYPES / COMPONENT+ATTACHMENT+SLOT REGISTRIES / 2 CLIENTBOUND PAYLOADS / 8 MIXINS / SERVER ABILITY COOLDOWNS / CONDITIONAL CURIOS BRIDGE / COMPONENT #41 CANDIDATE / BYTE+FULL-PACK QA FAIL-CLOSED |
...
Phase 2AM foi aberta sobre `main@433233164f61bbf6b6d5cb8aa9625cf286a79a23`, depois que PR #145 tornou efiscompat a Phase 2AL/component #40 canônica. O trabalho Apothic originalmente iniciado sob o rótulo Phase 2AL foi transplantado semanticamente para a nova branch, preservando o trabalho já integrado.

O draft PR #146 pertence à branch stale `docs/magic-catalog-phase2al-apothic-attributes-2.10.1` e deve permanecer fechado/retirado; ele não é autoridade para merge.
