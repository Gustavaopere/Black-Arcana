...
- Registry ID: `evocation_fortitude`
- Gate: unconditional in audited initializer
- State: `EXACT_REGISTRY / REACHABILITY_CONDITIONAL`

## Registration gate

The exact 1.0.8-fix audited registry initializer registers this identity without an optional-provider predicate.
