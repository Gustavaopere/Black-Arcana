...
O catálogo oficial ativo atual não lista este spell entre os 12 Holy ativos. O source audit 3.16.3 confirma, porém, que a implementação ainda existe e está marcada deprecated no `DefaultConfig`. Esta ficha é histórica/semântica e **não soma ao total ativo de 110 spells nem à cobertura ativa 75/110**.
...
- Source audit canônico: `wiki/modpack-catalog/providers/irons-spells/audits/source-3.16.3/spells/holy/cloud-of-regeneration.md`
