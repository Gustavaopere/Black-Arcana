# Current Magic-Relevant Provider Registry
...
|---:|---|---|---|---|---|---|
| 1 | Ars Nouveau | `ars_nouveau` | `ars_nouveau-1.21.1-5.13.1.jar` | `5.13.1` | ENGINE / PRIMARY PROVIDER | YES |
| 2 | Iron's Spells 'n Spellbooks | `irons_spellbooks` | `irons_spellbooks-1.21.1-3.16.3.jar` | `1.21.1-3.16.3` | ENGINE / PRIMARY PROVIDER | YES |
...
| 20 | Ars Polymorphia | `ars_polymorphia` | `ars_polymorphia-1.0.3.jar` | `1.0.3` | ARS GLYPH / SYSTEM PROVIDER | YES |
| 21 | Ars Nouveau's Flavors & Delight | `arsdelight` | `arsdelight-2.2.2.jar` | `2.2.2` | BRIDGE / COMPAT / PROGRESSION | NO / CONDITIONAL |
| 22 | Reliquified Ars Nouveau | `reliquified_ars_nouveau` | `reliquified_ars_nouveau-1.21.1-0.8.1.jar` | `0.8.1` | BRIDGE / COMPAT / PROGRESSION | NO / CONDITIONAL |
| 23 | Ars Hex | `ars_hex` | `ars_hex-1.21.1-5.0.4b.jar` | `5.0.4b` | BRIDGE / COMPAT / PROGRESSION | NO / CONDITIONAL |
...
| 31 | Ender's Spells and Stuff: Requiem | `ess_requiem` | `ess_requiem-0.1.7.jar` | `0.1.7` | SPELL PROVIDER / CONTENT ADDON | YES |
| 32 | Farmer's Spell 'n Spellbooks | `farmers_spell` | `farmers-spell-n-spellbook-1.0.5.1-1.21.1.jar` | `1.0.5.1-1.21.1` | SPELL PROVIDER / CONTENT ADDON | YES |
| 33 | Fire's Ender Expansion | `firesenderexpansion` | `firesenderexpansion-2.4.1.jar` | `2.4.1` | SPELL PROVIDER / CONTENT ADDON | YES |
| 34 | GTBC's Geomancy Plus | `gtbcs_geomancy_plus` | `gtbcs_geomancy_plus-1.1.0-1.21.1.jar` | `1.1.0-1.21.1` | SPELL PROVIDER / CONTENT ADDON | YES |
| 35 | Hazen N Stuff | `hazennstuff` | `hazennstuff-1.4.0.14.jar` | `1.4.0.14` | SPELL PROVIDER / CONTENT ADDON | YES |
| 36 | Cataclysm: Ignis Soulfires | `ignissoulfires` | `ignissoulfires-1.8.0.jar` | `1.8.0` | RITUAL / POWER / SUPERNATURAL PROVIDER | YES |
| 37 | Ignis Soulfires: Spellbooks | `ignissoulfires_spellbooks` | `ignissoulfires_spellbooks-1.1.0.jar` | `1.1.0` | SPELL PROVIDER / CONTENT ADDON | YES |
| 38 | ISS: Magic From The East | `iss_magicfromtheeast` | `iss_magicfromtheeast-1.1.5.jar` | `1.1.5` | SPELL PROVIDER / CONTENT ADDON | YES |
...
| 51 | Goety Iron | `goetyiron` | `GoetyIron-1.21.1-NeoForge-3.1.jar` | `3.1` | BRIDGE / COMPAT / PROGRESSION | NO / CONDITIONAL |
| 52 | Create: Wizardry | `create_wizardry` | `create_wizardry-1.21.1-0.5.1-pre1.jar` | `1.21.1-0.5.1-pre1` | BRIDGE / COMPAT / PROGRESSION | NO / CONDITIONAL |
...
| 70 | Create Enchantment Industry Plus | `create_enchantment_industry_plus` | `create_enchantment_industry_plus-1.1.1-1.21.1.jar` | `1.1.1` | BRIDGE / COMPAT / PROGRESSION | NO / CONDITIONAL |
| 71 | Create: Enchantable Machinery | `createenchantablemachinery` | `createenchantablemachinery-3.6.0+mc1.21.1-neoforge.jar` | `3.6.0` | GEAR / ENCHANT / SUPPORT CONTENT | NO / CONDITIONAL |
| 72 | Apotheosis/Create Addon | `apotheoticcreation` | `apotheoticcreation-2.0.0.jar` | `2.0.0` | BRIDGE / COMPAT / PROGRESSION | NO / CONDITIONAL |
| 73 | Dis-Enchanting Table | `disenchanting_table` | `disenchanting_table-merged-1.21.1-5.0.2.jar` | `5.0.2` | GEAR / ENCHANT / SUPPORT CONTENT | NO / CONDITIONAL |
...
| 92 | Vampirism Integrations | `vampirism_integrations` | `vampirism_integrations-1.21.1-1.10.2.jar` | `1.10.2` | BRIDGE / COMPAT / PROGRESSION | NO / CONDITIONAL |
...
This is the baseline set discovered from the current magic guide plus explicit current-modlist deltas. During Phase 2, a provider discovered in gameplay/general guides or through a bridge may be added if it exposes magic-relevant capabilities. Addition to this registry does not itself imply that a component creates spells.
