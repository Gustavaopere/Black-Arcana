...
| Hazen N Stuff | `1.4.0.14` | 38 | ✅ `COUNTED_SOURCE_PINNED` | 38 active Iron's spell registrations no source pin 1.4.0.14; `brimstone_hellblast`, `supernova` e o registro comentado `reign_of_tyros` ficam excluídos. |
...
| **Total estrito reconstruível** |  | **1382** |  | Denominador semântico global ainda incompleto; nenhuma porcentagem final é declarada. |
