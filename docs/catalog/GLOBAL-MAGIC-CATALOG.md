...
| --- | --- | --- |
| Astral Severance | ✅ Catalogado | ⚠️ Stage 07.07 parcial; `main` possui múltiplas tranches canônicas de Astral, mas este índice não promove completude individual além de `plans/STATUS.md`. |
