...
- **07.05–07.07** — pending and must follow sequentially from the latest canonical `main` after 07.04.
...
The stage may be split into sequential domain branches if the review surface becomes too large; 07.01 established that pattern and 07.02–07.04 preserve the same isolation discipline.
