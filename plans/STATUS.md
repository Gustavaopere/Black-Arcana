...
| 07 Spell Domains | 🟦 IN PROGRESS — 07.01–07.05 CANONICAL | 07.05 PR #54 final head `bf23cfc...` passed #1142; merge `f57f254...` passed exact-SHA post-merge #1143 with canonical artifact; 07.06–07.07 pending; real-modpack/manual acceptance deferred |
...
07.06 Forbidden Domains through 07.07 Familiars & Divination remain pending and must continue sequentially only by explicit instruction. They are not pulled in through stale PR #22 ancestry. Optional provider/host behavior that requires the real modpack remains part of the deferred final validation campaign.
