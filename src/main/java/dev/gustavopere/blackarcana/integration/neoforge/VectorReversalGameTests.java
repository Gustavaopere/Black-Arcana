...
public final class VectorReversalGameTests {
    ...
    public static void defaultVectorReversalAppliesBoundedImpulseOncePerTarget(GameTestHelper helper) throws Exception {
        ...
        Object result = applyDefault(server, caster.getUUID(), List.of(target.getUUID(), target.getUUID()), 10.0D, 0.0D, 0.0D);
    ...
    public static void invalidDirectionFailsClosedWithoutMotion(GameTestHelper helper) throws Exception {
        ...
        Object result = applyDefault(server, caster.getUUID(), List.of(target.getUUID()), 0.0D, 0.0D, 0.0D);
    ...
    public static void targetCapPreventsFifthSettlement(GameTestHelper helper) throws Exception {
        ...
        Object result = applyDefault(server, caster.getUUID(),
    ...
    private static Object applyDefault(MinecraftServer server, UUID casterId, List<UUID> targetIds,
        ...
        Method method = runtime.getMethod("applyDefault", MinecraftServer.class, UUID.class, List.class,
