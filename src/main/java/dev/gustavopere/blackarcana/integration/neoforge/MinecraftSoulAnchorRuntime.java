...
import dev.gustavopere.blackarcana.content.souls.SoulDeathTransactionIds;
 ...
 *
 * <p>Balance remains externally configured: this runtime does not choose spirit thresholds,
 * anchor caps, lockout duration or restored health. It only owns atomic death prevention,
 * bounded ledger state and durable settlement.</p>
 */
public final class MinecraftSoulAnchorRuntime {
    ...
    private static void onLivingDeath(LivingDeathEvent event) {
        ...
        synchronized (state) {
            ...
            UUID deathTransactionId = SoulDeathTransactionIds.forPlayerTick(player.getUUID(), nowTick);
