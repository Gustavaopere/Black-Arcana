...
class NoeticViewPacketTest {
    @Test
    void packetRoundTripsBorrowedSightInstruction() {
    ...
    @Test
    void packetConstructorRejectsMalformedWireEnumsOrNonBorrowedSightKinds() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new NoeticViewPacket(
                ...
                NoeticObservationKind.ASTRAL_SEVERANCE.name(),
                1));
    }
}
